...
<input name="dob" type="text" class="required" id="dob" onChange="age(this)" value="" size="15" readonly>
                      <input name="button" type="button" onClick="displayCalendar(document.forms[0].dob,'dd/mm/yyyy',this)" value="Calender" >
</div>
